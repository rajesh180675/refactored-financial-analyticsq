import streamlit as st import pandas as pd import numpy as np import plotly.graph_objects as go from ui.base_tab import BaseTab

class TrendsTab(BaseTab): def render(self, data: pd.DataFrame): st.header("📉 Trend Analysis & ML Forecasting")
...
def _render_ml_forecasting(self, data):
    ...
    if st.button("🚀 Generate ML Forecast", type="primary"):
        if not selected_metrics:
            ...
            self._generate_forecast(data, selected_metrics, forecast_periods, model_type, confidence_level)
